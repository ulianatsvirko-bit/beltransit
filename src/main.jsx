...
function App() {
  ...
  return (
    <>
      ...
      <a className={`mobile-bottom-telegram${isBlogPage || isCustomsArticlePage || isBelarusRouteArticlePage || isPaymentArticlePage || isLtlFtlArticlePage || isFirstImportArticlePage ? " blog-page-mobile-telegram" : ""}`} href="https://t.me/beltransit">
        Написать в Telegram <Send size={18} />
      </a>
    </>
  );
