...
const buyoutFaq = [
  ...
  [
    ...
    "Обычно от 5 000 €. Меньшие суммы обсуждаем индивидуально — зависит от экономики сделки, страны и типа товара.",
  ],
  [
...
const supplierSearchPricing = [
  {
    icon: "📋",
    title: "Поиск и отчёт",
    text: "Находим 3-5 проверенных поставщиков с контактами, ценами и условиями поставки. Стоимость — от 500 €, уточняйте у менеджера.",
  ...
  },
  {
    ...
    questions: [
      ...
      [
        ...
        "Обычно от €5,000. Меньшие суммы обсуждаем индивидуально — зависит от страны, товара и экономики сделки.",
      ],
      [
        "Как я буду уверен что вы не исчезнете с деньгами?",
