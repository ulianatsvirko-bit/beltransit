...
// Fallback lastmod for indexable routes without a tracked publish/update date
// (i.e. everything that isn't a dated blog post). Bump when a broad content
// pass touches most pages, as happened on this date.
export const DEFAULT_LASTMOD = "2026-07-11";
